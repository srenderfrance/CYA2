...
## General Guidelines
This is a .net 10 app that uses blazor, dapper and mysql, radzen components and uses clean architecture. The app is for a small non-profit and allows staff to keep track of their fundraising accounts.
